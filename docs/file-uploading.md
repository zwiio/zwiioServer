...
We prefer not to delete files during profile changes because restoring data may otherwise leave broken references. If hard deletion is required, add a deliberate cleanup handler or scheduled job appropriate to your storage driver.
